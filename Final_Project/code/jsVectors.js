...
var Vector = (function() {
  ...
  // high level methods that return new vectors or scalars
  ...
  // Many of these change the vector being operated on
  // As a general guide, if a value is returned,
  // the object being operated on does not change.
  Vector.prototype = {
	set: 
		function(v, y, z) {
